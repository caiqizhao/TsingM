...
public class Utility {
    ...
    public static List<List<RecommendFood>> getBreakFast(){
        ...
        RecommendFood food01=new RecommendFood("豆浆","220.0毫升","68千卡","31","3.0","1.2","1.6","低热量豆制品",false,"早餐");
        RecommendFood food02=new RecommendFood("鸡蛋（煮），又叫水煮蛋，白煮蛋，煮蛋，煮鸡蛋","106.0克","153千卡","144","13.3","8.8","2.8","高胆固醇-肉蛋类",false,"早餐");
        RecommendFood food03=new RecommendFood("玉米(鲜)","132.0克","148千卡","112","4.0","1.2","22.8","低碳水化合物-谷薯类",false,"早餐");
        RecommendFood food04=new RecommendFood("榛子仁（熟）","16.0克","100千卡","628","15.6","52.9","26.7","坚果、大豆及制品",false,"早餐");
        RecommendFood food11=new RecommendFood("牛奶，又叫纯牛奶，牛乳","102.0毫升","55千卡","54","3.0","3.2","3.4","乳制品类",false,"早餐");
        RecommendFood food12=new RecommendFood("馒头","102.0克","227千卡","223","7.0","1.1","47.0","主食类",false,"早餐");
        RecommendFood food13=new RecommendFood("橙，又叫橙子、金球、香橙、黄橙、脐橙","201.0克","96千卡","48","0.8","0.2","11.1","水果类",false,"早餐");
        RecommendFood food14=new RecommendFood("小米粥","192.0克","88千卡","46","1.4","0.7","8.4","主食类",false,"早餐");
    ...
    public static List<List<RecommendFood>> getLunch(){
        ...
        RecommendFood food01=new RecommendFood("米饭","280.0克","325千卡","116","2.6","0.3","25.9","主食类",false,"午餐");
        RecommendFood food02=new RecommendFood("花菜，又叫菜花、花椰菜、椰花菜、洋花菜","82.0克","16千卡","20","1.7","0.2","4.2","蔬菜菌藻类",false,"午餐");
        RecommendFood food03=new RecommendFood("猪肉(肋条肉)","70.0克","398千卡","568","9.3","59.0","0.0","肉蛋类",false,"午餐");
        RecommendFood food11=new RecommendFood("米饭","291.0克","338千卡","116","2.6","0.3","25.9","主食类",false,"午餐");
        RecommendFood food12=new RecommendFood("草鱼，又叫鲩鱼、混子、草鲩、草包鱼、草根鱼、草青、白鲩","321.0克","363千卡","113","16.6","5.2","0.0","海鲜类",false,"午餐");
        RecommendFood food13=new RecommendFood("甜瓜，又叫甘瓜、库洪（维吾尔语）","161.0克","42千卡","26","0.4","0.1","6.2","水果类",false,"午餐");
        RecommendFood food14=new RecommendFood("上海青，又叫青菜，小青菜","52.0克","9千卡","18","1.7","0.2","3.2","蔬菜类",false,"午餐");
        List<RecommendFood> foodList1=new ArrayList<>();List<RecommendFood> foodList2=new ArrayList<>();
    ...
    public static List<List<RecommendFood>> getSupper(){
        ...
        RecommendFood food01=new RecommendFood("米饭","145.0克","168千卡","116","2.6","0.3","25.9","主食类",false,"晚餐");
        RecommendFood food02=new RecommendFood("菠菜，又叫菠棱菜、赤根菜、波斯草、鹦鹉菜、鼠根菜、角菜","45.0克","13千卡","28","2.6","0.3","4.5","蔬菜菌藻类",false,"晚餐");
        RecommendFood food03=new RecommendFood("酸奶","121.0克","87千卡","72","2.5","2.7","9.3","高钙-乳制品类",false,"晚餐");
        RecommendFood food04=new RecommendFood("鸭肉，又叫鸭子、鹜肉、家凫肉","20.0克","48千卡","240","15.5","19.7","0.2","肉类",false,"晚餐");
        RecommendFood food11=new RecommendFood("米饭","133.0克","154千卡","116","2.6","0.3","25.9","主食类",false,"晚餐");
        RecommendFood food12=new RecommendFood("猪小排，又叫排骨、猪排","64.0克","178千卡","278","16.7","23.1","0.7","肉类",false,"晚餐");
        RecommendFood food13=new RecommendFood("小白菜，又叫青菜、油白菜、白菜秧、白菜、杭白菜","52.0克","9千卡","17","1.5","0.3","2.7","蔬菜菌藻类",false,"晚餐");
        List<RecommendFood> foodList1=new ArrayList<>();List<RecommendFood> foodList2=new ArrayList<>();
        foodList1.add(food01);foodList1.add(food02);foodList1.add(food03);foodList1.add(food04);
