...
public class ConsumeEnergyView extends View {

    private int startColor = 0xff38f9d7;
    private int endColor = 0xFF24C68A;
    ...
    private static final String TAG = "ConsumeEnergyView";


    public ConsumeEnergyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ConsumeEnergyView(Context context, AttributeSet attrs, int defStyleAttr) {
